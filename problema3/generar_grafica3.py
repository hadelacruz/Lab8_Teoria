...
def generar_graficas():
    ...
    csv_file = 'resultados3.csv'
    
    if not os.path.exists(csv_file):
        print(f"❌ Error: No se encontró el archivo '{csv_file}'")
        print("   Por favor, ejecuta primero: .\\ejecutar3.bat")
        return
    ...
    print("="*60)
    print("GENERANDO GRÁFICAS - PROBLEMA 3")
    print("="*60)
    ...
    ax1.set_title('Problema 3: Tiempo vs Tamaño de entrada\n(Escala Lineal)', 
    ...
    ax2.set_title('Problema 3: Tiempo vs Tamaño de entrada\n(Escala Log-Log)', 
                  fontsize=14, fontweight='bold', pad=15)
    ax2.set_xscale('log')
    ax2.set_yscale('log')
    ...
    # Análisis
    print("\n📈 ANÁLISIS:")
    print(f"   • Complejidad: O(n²) - Cuadrática")
    ...
    print(f"\n💡 Bucle i: n/3 iteraciones, Bucle j: n/4 iteraciones")
    print(f"   (n/3) × (n/4) = n²/12 → O(n²)")
    print("\n¡Completado! 🎉\n")
